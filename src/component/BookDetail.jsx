    ...
    <Box>
      <Box className={classes.headerbsummary}>
        <Box className={classes.homebook}>
          ...
          <Box className={classes.book}> </Box>
        </Box>
      </Box>
        ...
        <Box className={classes.container4}>
          <Box className={classes.buttons}>
            <Box className={classes.bookimg}>
              <img src="Image 11.png" width="65%" height="65%" />
            </Box>
          ...
          <Box className={classes.bookdetails}>
            <Box className={classes.bookdetails1}>
              <Box className={classes.booktitle1}>Don't make me think</Box>
              <Box sx={{ height: "1%" }}></Box>
              <Box className={classes.bookauthor1}>By Steve krug</Box>
              ...
              <Box className={classes.bookpoints1}>
                ...
                <Box className={classes.bookquantity1}>20</Box>
              </Box>
              <Box className={classes.bookprice1}>
                <Box className={classes.bookdiscount1}>
                Rs. 1500
                </Box>
                <Box className={classes.bookcost1}>Rs.2000</Box>
              </Box>
              ...
              <Box className={classes.bookparagraph}>
                ...
                <Box className={classes.para1}>
                  ...
                  <Box
                    ...
                    sx={{ marginLeft: "9px", fontSize: "12px", opacity: "0.8" }}
                  >
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labor irure dolor in reprere  Excepteur sint occaecat cupidatat non proident."
                  </Box>
                </Box>
              </Box>
